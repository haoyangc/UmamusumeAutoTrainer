...
FACTOR_DOUBLE_CONFIRM = UI("FACTOR_DOUBLE_CONFIRM", [template.UI_FACTOR_DOUBLE_CONFIRM], [])
...
scan_ui_list = [MAIN_MENU,
                ...
                ACTIVITY_REWARD,
                INFO] # put INFO after other ui templates which are subset of INFO
